angular
    ...
    .directive('styleSwitcher', function ($rootScope,$document,$state,$timeout) {
        return {
            restrict: 'E',
            templateUrl : 'client/style_switcher/style_switcher.html',
            ...
            link: function (scope, elem, attr) {
                ...
                scope.changeTheme = function($event,theme) {
                    ...
                    if(theme.class == '') {
                        ...
                        localStorage.setItem("admin_theme", theme.class);
                    }
                };
                ...
                if((localStorage.getItem("admin_sidebar_mini") !== null && localStorage.getItem("admin_sidebar_mini") == '1')) {
                ...
                $('#style_sidebar_mini')
                    .on('ifChecked', function(event){
                        localStorage.setItem("admin_sidebar_mini", '1');
                    ...
                    .on('ifUnchecked', function(event){
                        localStorage.removeItem('admin_sidebar_mini');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                ...
                // change input's state to checked if mini sidebar is active
                if((localStorage.getItem("admin_boxed_layout") !== null && localStorage.getItem("admin_boxed_layout") == '1')) {
                ...
                $('#style_layout_boxed')
                    .on('ifChecked', function(event){
                        localStorage.setItem("admin_boxed_layout", '1');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.boxedLayoutActive = true;
                            $state.go($state.current, {}, {reload: true});
                    ...
                    .on('ifUnchecked', function(event){
                        localStorage.removeItem('admin_boxed_layout');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
